...
COPY = {
    "uk": {
        ...
        "start_intro": "<b>RIAKHIN CARD - ваша цифрова візитка.</b>\n\nЦе одне посилання, де людина побачить головне про вас і вибере зручний спосіб зв’язатися.\n\nСпочатку виберіть мову спілкування та мову візитки. Потім побачите структуру візитки й виберете потрібні розділи. Для заповнення знадобляться ім’я, сфера роботи, опис, а також фото, логотип або варіант без зображення.",
        ...
        "card_language_count": "Скільки мов потрібно для візитки?\n\nОдна мова: 1200 грн / $29. Дві мови: 1700 грн / $39. Дві мови потрібні, якщо ви працюєте з аудиторією з різних країн або хочете надсилати одне посилання клієнтам різними мовами.",
        ...
        "contacts_prompt": "Виберіть потрібні пункти, потім натисніть «Готово ✓» - після цього заповните кожен контакт по черзі.",
        ...
        "phones_prompt": "Додайте потрібні номери телефону. Кожен номер матиме зрозумілу позначку.",
        "phone_work": "Робочий", "phone_personal": "Особистий", "phone_salon": "Салон", "phone_other": "Інший",
        "phone_value": "Номер телефону - <b>{label}</b>:", "phone_required": "Напишіть номер телефону або поверніться назад.",
    ...
    "en": {
        ...
        "start_intro": "<b>RIAKHIN CARD - your digital business card.</b>\n\nIt is one link where people can see what matters about you and choose the easiest way to contact you.\n\nFirst choose the interface language and the card language. Then review the card structure and select the sections you need. You will need your name, professional field, description, and a photo, logo, or no-image option.",
        ...
        "card_language_count": "How many languages do you need for the card?\n\nOne language: 1200 UAH / $29. Two languages: 1700 UAH / $39. Choose two languages if you work with audiences in different countries or want to share one link with clients in different languages.",
        ...
        "contacts_prompt": "Select the items you need, then tap “Done ✓” and enter each contact in turn.", "phone": "Phone", "email": "Email", "other_contact": "Other contact", "send_contact": "Send the contact for <b>{name}</b>.",
        ...
        "phones_prompt": "Add the phone numbers you need. Each number will have a clear label.", "phone_work": "Work", "phone_personal": "Personal", "phone_salon": "Studio", "phone_other": "Other", "phone_value": "Phone number - <b>{label}</b>:", "phone_required": "Enter a phone number or go back.",
...
RU_COPY = {
    ...
    for key, value in {
        ...
        "card_language_count": "Сколько языков нужно для визитки?\n\nОдин язык: 1200 грн / $29. Два языка: 1700 грн / $39. Два языка нужны, если вы работаете с аудиторией из разных стран или хотите отправлять одну ссылку клиентам на разных языках.",
        ...
        "social_prompt": "Выберите нужные пункты, затем нажмите «Готово ✓» - после этого заполните ссылки по очереди.", "other_social": "Другая соцсеть (название + ссылка)", "send_social": "Пришлите ссылку на <b>{name}</b>.", "next_social": "Теперь ссылку на <b>{name}</b>.", "contacts_prompt": "Выберите нужные пункты, затем нажмите «Готово ✓» - после этого заполните каждый контакт по очереди.", "phone": "Телефон", "email": "Email", "other_contact": "Другой контакт", "send_contact": "Пришлите контакт для <b>{name}</b>.", "other_name": "Напишите название мессенджера или другого способа связи. Например: Signal или Discord.", "other_name_required": "Напишите название мессенджера или способа связи.", "other_value": "Теперь пришлите контакт или ссылку для <b>{name}</b>.", "other_value_required": "Пришлите контакт или ссылку либо вернитесь назад.",
        "phones_prompt": "Добавьте нужные номера телефона. У каждого номера будет понятная подпись.", "phone_work": "Рабочий", "phone_personal": "Личный", "phone_salon": "Салон", "phone_other": "Другой", "phone_value": "Номер телефона - <b>{label}</b>:", "phone_required": "Напишите номер телефона или вернитесь назад.",
